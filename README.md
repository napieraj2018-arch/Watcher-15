...
- **Sun & Fun** — wykonano pełny test żywego wyszukiwania `room1=2,5,7`. Strona potwierdziła „2 dorosłych 2 dzieci” i dla dokładnego wylotu 24.09.2026 zwróciła jawną **„Cena całkowita 8 304 zł”**. Dodano twardą kontrolę daty, ponieważ zapytania na 25/26.09 były automatycznie przesuwane przez serwis na 27.09; takie przesunięte wyniki są odrzucane. Parser jakości został dodatkowo zaostrzony: gwiazdki, ocena i liczba opinii muszą pochodzić z tego samego bloku DOM, który zawiera dokładnie jedną cenę rodzinną. Zapobiega to przypadkowemu „pożyczaniu” oceny z sąsiedniego hotelu. Kanał pozostaje diagnostyczny do czasu uzyskania pełnego zestawu `>=4★`, `>=8/10`, `>=30 opinii` dla dokładnie tej samej wycenionej oferty.
